...
KalmanFilter::KalmanFilter(int stateSize_ = 0, int measSize_ = 0, int uSize_=0) :
...
void KalmanFilter::init(Eigen::VectorXd &x_, Eigen::MatrixXd& P_,
...
Eigen::VectorXd KalmanFilter::predict(Eigen::MatrixXd& A_, Eigen::MatrixXd &B_,
    Eigen::VectorXd &u_)
{
    A = A_;
    B = B_;
